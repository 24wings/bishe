...
export let userOrderView: View = {
    title: "我的订单",
    dvoFullName: "Wings.Projects.Rcxh.DVO.Product.UserOrderManage",
    allowCreate: false,
    allowDelete: false,
    allowEdit: false,
...
export let ordersView: View = {
    title: "我的订单",
    dvoFullName: "Wings.Projects.Rcxh.DVO.Product.HistoryOrderManage",
    allowCreate: false,
    allowDelete: false,
    allowEdit: false,
    dataSource: new DataSource({
        store: AspNetData.createStore({
            key: "id",
            loadUrl: environment.ip + "/api/Hk/order/loadHistoryOrder",
            insertUrl: environment.ip + "/api/Hk/order",
            updateUrl: environment.ip + "/api/Hk/order",
            deleteUrl: environment.ip + "/api/Hk/order",
        })
